...
public class KTectoySunmiPrinter  {
    ...
    private static KTectoySunmiPrinter helper = new KTectoySunmiPrinter();

    private KTectoySunmiPrinter() {}

    public static KTectoySunmiPrinter getInstance() {
        return helper;
    }
    ...
    public ServiceConnection connService = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mPrinter = extPrinterService;
        }
    };

    public void connectKPrintService(Context context) {
        Intent intent = new Intent();
        intent.setPackage("com.sunmi.extprinterservice");
        intent.setAction("com.sunmi.extprinterservice.PrinterService");
        context.bindService(intent, connService, Service.BIND_AUTO_CREATE);
    }
